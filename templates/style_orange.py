...
FONT_PATH = os.path.join(os.path.dirname(__file__), '..', 'fonts', 'KeinannMaruPOP（中文安装这个）.ttf')
...
def build_svg(text: str, font_size: int = 72, letter_spacing: int = 4,
              grad_top: str = '#FFD44F', grad_bottom: str = '#FF8C00', **kwargs) -> str:
...
<svg xmlns="http://www.w3.org/2000/svg" width="{w}" height="{h}" viewBox="0 0 {w} {h}">
  <defs>
    ...
    <filter id="outline_dark" x="-15%" y="-15%" width="130%" height="130%">
      ...
      <feFlood flood-color="#B85000" result="color"/>
  ...
  <text x="{cx}" y="{cy}"
    ...
    stroke="#B85000" stroke-width="9">{text}</text>
